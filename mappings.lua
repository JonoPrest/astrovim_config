return {
    ...
    n = {
        ...
        ["<leader>sf"] = {
            ...
            desc = "Search All Matches (SearchBoxMatchAll)"
        },
        ["<leader>ss"] = {
            ":SearchBoxIncSearch<cr>",
            desc = "Search Nearest Match (SearchBoxIncSearch)"
        },
        ["<leader>sr"] = {
            ":SearchBoxReplace confirm=menu<cr>",
            desc = "Search And Replace (SearchBoxReplace)"
        },
        ["<leader>soe"] = {
            ":SearchBoxReplace confirm=menu<cr> exact=true",
            desc = "Exact Search And Replace (SearchBoxReplace)"
        },
        ["<leader>soi"] = {
            ":SearchBoxReplace confirm=menu<cr> modifier=case-sensitive",
            desc = "Exact Search And Replace (SearchBoxReplace)"
        }
    },
    i = {
    ...
    v = {
        ...
        ["<A-Down>"] = {
            ":m '>+1<CR>gv=gv",
            desc = "Move selection lines down"
        },
        ["<A-Up>"] = {
            ":m '<-2<CR>gv=gv",
            desc = "Move selection lines up"
        },
        ["<A-S-Down>"] = {
            " : '<,'>yank<CR>Pgv=gv",
            desc = "Copy selectino lines down"
        },
        ["<A-S-Up>"] = {
            " : '<,'>yank<CR>`]pgv=gv",
            desc = "Copy selectino lines up"
        },
        -- Toggleterm
        ["<C-'>"] = {
            ":ToggleTerm<CR>",
        ...
        ["<leader>sf"] = {
            ":SearchBoxMatchAll visual_mode=true<cr>",
            desc = "Search All Matches (SearchBoxMatchAll)"
        },
        ["<leader>ss"] = {
        ...
        ["<leader>sr"] = {
            ":SearchBoxReplace visual_mode=true confirm=menu<cr>",
            desc = "Search And Replace (SearchBoxReplace)"
        }
    },
    t = {
